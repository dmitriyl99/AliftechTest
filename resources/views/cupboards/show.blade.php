        ...
        <div class="col-sm-12 col-md-4 col-lg-3">
            <div class="card text-center">
                <div class="d-flex justify-content-end align-items-center mt-1 mr-1">
                    <a class="text-warning" data-toggle="tooltip" title="Редактировать" href="{{ route('cupboards.edit', $cell->slug) }}"><i class="fas fa-edit"></i></a>
                    <form action="{{ route('cupboards.destroy', $cell->slug) }}" method="post">
                        @csrf
                        @method('delete')
                ...
                <div class="card-body">
                    <a href="{{ route('cupboards.show', $cell->slug) }}" class="card-title">{{ $cell->title }}</a>
                </div>
            </div>
        </div>
    @endforeach
